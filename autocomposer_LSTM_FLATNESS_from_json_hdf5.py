...
#load_model = "saved_models/weights/SIN-10TS-128Neurons-2532-0.0108-.hdf5"
...
while i < 20:
    ...
    prediction_input_ = np.append(prediction_input.flatten()[1:], class_to_note[class_]) #adds data(prediction) to prediction
    ...
    prediction_acc.append(class_to_note[class_])
    i = i+1

print(prediction_class)
print(prediction_acc)
#result = list(map(getClosestCandidate, prediction_input_))[0:10]#se esta leyendo n veces el archivo?
