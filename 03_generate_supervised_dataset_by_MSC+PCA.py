...
file_in = "segments.csv"
folder_in = "segments_audiotest/"
folder_out = "clusters_audiotest/"
csv_fileOut = "supervised_dataset_audiotest.csv"
...
def meanShift(features):  #features is [[float]]
    ...
    features_pca = pca.fit_transform(tr_features)

    bandwidth = estimate_bandwidth(features_pca, quantile=0.15,
                                    n_samples=None)
